...
def createHashlist(endpoint, certpath, accessKey, name, isSalted, isSecret, isHexSalt, seperator, format, hashtypeId, accessGroupId, data, useBrain, brainFeatures):
  createhashlist = { 'section':'hashlist', 'request':'createHashlist', 'name':name, 'isSalted':isSalted, 'isSecret':isSecret, 'isHexSalt':isHexSalt, 'seperator':seperator, 'format':format, 'hashtypeId':hashtypeId, 'accessGroupId':accessGroupId, 'data':data, 'useBrain':useBrain, 'brainFeatures':brainFeatures, 'accessKey':accessKey }
